...
CKEDITOR.stylesSet.add( 'default', [
	...
	*/
	{ name: '10px',			element: 'span', attributes: { 'style': 'font-size:10px' } },
	...
	{ name: '24px',			element: 'span', attributes: { 'style': 'font-size:24px' } },
	{ name: '30px',			element: 'span', attributes: { 'style': 'font-size:30px' } },
	{ name: '40px',			element: 'span', attributes: { 'style': 'font-size:40px' } },
