...
<div id="contentContainer">
	<div id="content">
		...
		<div id="tabs" class="clearfix">
			<h3>{$_title|cat:'管理'}</h3>
			<ul>
				<li class="active"><a href="{$appPath}/{$param.controller}/list/?type={$param.type|escape}"><span>一覧</span></a></li>
				<li><a href="{$appPath}/{$param.controller}/edit/{editnew}&amp;type={$param.type|escape}"><span>新規登録</span></a></li>
			</ul>
		</div>
			...
			<table>
				<tbody>
					...
					<tr class="{cycle values='odd,even'}">
						...
						<td class="nowrap_ctr">
							<a href="{$appPath}/{$param.controller}/edit/?id={$value[each].id|escape}&amp;type={$value[each].type|escape}" class="edit">編集</a>
		...
		<div id="helpDescription">
			<div class="helpSpace">
				<ul>
					...
					<li>※<img src="{$appPath}/images/sys/link_go.png" class="icon" />アイコンはURLリンク設定を示しています。</li>
				</ul>
			</div>
		</div>
